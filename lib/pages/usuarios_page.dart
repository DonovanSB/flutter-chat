...
class _UsuariosPageState extends State<UsuariosPage> {
  ...
  final usuarios = [
    Usuario(
        uid: '1', nombre: 'Vanessa', email: 'test1@gmail.com', online: true),
    Usuario(
        uid: '2', nombre: 'Alejandra', email: 'test2@gmail.com', online: true),
    Usuario(
        uid: '3', nombre: 'Tatiana', email: 'test3gmail.com', online: false),
  ];
  @override
